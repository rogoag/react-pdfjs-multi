import React, { PureComponent, Fragment as Fragment$1 } from 'react';
        ...
        React.createElement("div", null,
            ...
            React.createElement(I18nContext.Consumer, null, function (_a) {
                ...
                return (React.createElement(Fragment$1, null,
                    ...
                    React.createElement("div", { className: "button-group" },
                        React.createElement("button", { className: "renderer-controls-button", type: "button", onClick: onPrint },
                            React.createElement("span", { className: "print-label" }, printLabel)))));
            }))));
};
    ...
    PdfRenderer.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "renderer-container" },
            controls && (React.createElement(I18nContext.Provider, { value: __assign(__assign({}, defaultI18n), i18nData) },
                React.createElement(PdfControls, { autoZoom: autoZoom, downloadBtn: downloadBtn, scale: scale, setScale: this.setScale, onDownload: this.download, onPrint: this.onPrint, onZoomIn: this.zoomIn, onZoomOut: this.zoomOut, onRotateRight: this.rotateRight, onRotateLeft: this.rotateLeft }))),
